...
| 4 | User Dashboard Experience | Users can manage and connect to their machines self‑service. | DASH-01–05 | Users see status and remaining time clearly and can connect via Parsec from the dashboard without admin help. |
